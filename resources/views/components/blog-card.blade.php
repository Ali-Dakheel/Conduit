<article class="flex max-w-xl flex-col items-start justify-between hover:shadow-lg transition-shadow duration-200 p-6 rounded-lg border border-gray-100">
    ...
    <div class="mt-4 flex items-center justify-between text-xs text-gray-500 w-full border-t border-gray-100 pt-4">
    ...
    <div class="relative mt-4 flex items-center gap-x-4">
        ...
        <div class="text-sm/6">
            <p class="font-semibold text-gray-900">
                <a href="/profile/{{$article->author->name}}" class="hover:text-primary transition-colors">
